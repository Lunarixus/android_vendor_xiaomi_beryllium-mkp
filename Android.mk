...
#LOCAL_MODULE_OWNER := xiaomi
#LOCAL_SRC_FILES := proprietary/priv-app/HHotwordEnrollmentXGoogleWCD9340/HotwordEnrollmentXGoogleWCD9340.apk
#LOCAL_CERTIFICATE := platform
#LOCAL_MODULE_TAGS := optional
#LOCAL_MODULE_CLASS := APPS
#LOCAL_DEX_PREOPT := false
...
LOCAL_MODULE_OWNER := xiaomi
LOCAL_SRC_FILES := proprietary/priv-app/seccamservice/seccamservice.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
